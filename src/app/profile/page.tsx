...
const Profile = () => {
  ...
  const userCards = cards.filter((card) =>
    collection.purchasedCards.includes(card.id)
  );
            ...
            <TabsContent value="profile" className="space-y-8">
              <div className="card-glass p-8">
                <div className="flex items-center gap-8 mb-8">
                  <div className="w-32 h-32 rounded-full bg-linear-to-br from-primary to-secondary flex items-center justify-center text-4xl font-bold">
                    {username.charAt(0)}
                  </div>
